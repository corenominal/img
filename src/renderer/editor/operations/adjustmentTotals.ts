...
// (exposure/highlights/shadows/temperature/tint/vibrance/gamma rewrite
// pixels directly — see ExposureOperation.ts/HighlightsOperation.ts/
// ShadowsOperation.ts/TemperatureOperation.ts/TintOperation.ts/
// VibranceOperation.ts/GammaOperation.ts). Add new kinds here as Phase 12's
// remaining adjustments land.
