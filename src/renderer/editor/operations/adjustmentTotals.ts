...
// (exposure/highlights/shadows rewrite pixels directly — see
// ExposureOperation.ts/HighlightsOperation.ts/ShadowsOperation.ts). Add
// new kinds here as Phase 12's remaining adjustments land.
export type AdjustmentSliderKind = AdjustmentKind | 'exposure' | 'highlights' | 'shadows';
